...
public class JDBC_CRUD {
    ...
    /**
     * Constructor creates connection and statement.    * @param adress Adress of database.    * @param login Login for database.    * @param password Password for database.    * @throws SQLException
     */
    ...
    /**
     * Creates new programmer in database.    * @param name Programmer name.    * @param location Programmer location.    * @param qualification Programmer Qualification.    * @throws SQLException
     */
    ...
    /**
     * Delete programmer from database.    * @param    * @throws SQLException
     */
    ...
    /**
     * Show table and return ResultSet.    * @return Returns table contents in ResultSet.    * @throws SQLException
     */
    ...
    /**
     * Updates record based on ID.    * @param id Programmer_id.    * @param name Programmer Name.    * @param location Programmer location    * @param qualification Programmer qualification    * @throws SQLException
     */
    ...
    /**
     * Truncates table.    * @throws SQLException
     */
